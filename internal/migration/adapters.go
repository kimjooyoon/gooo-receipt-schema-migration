...
func GenerateAdapters(ir IR, outputDir string) ([]ArtifactRef, error) {
	...
	if ir.Version == "v2" {
		...
		validator.Operations = append(validator.Operations, "VALIDATE_FOUNDATION_AUTHORIZATION", "VALIDATE_FOUNDATION_RECEIPT", "VALIDATE_CHANGED_PATH_TUPLES", "VALIDATE_PROTECTED_INTERSECTION", "VALIDATE_FOUNDATION_CARDINALITY", "VALIDATE_GUARDIAN_PRECEDENCE")
	}
...
func adapterOperations(ir IR) []string {
	...
	if ir.Version == "v2" {
		...
		operations = append(operations, "VALIDATE_FOUNDATION_AUTHORIZATION", "VALIDATE_FOUNDATION_RECEIPT", "VALIDATE_CHANGED_PATH_TUPLES", "VALIDATE_PROTECTED_INTERSECTION", "VALIDATE_FOUNDATION_CARDINALITY", "VALIDATE_GUARDIAN_PRECEDENCE")
	}
	return operations
}
